...
** CONSIDERING Alien Apocalypse
   ...
   a world ruled by a tyrant on the other). One world is always at
   peace and the other is always in despair. When the coins flip, the
   worlds' roles flip. At present, the King of the Hospital world is
   on top and (thanks to the Plague King) will soon reverse, while the
   tyrant world is on the bottom and (thanks to a future revolt) will
   soon reverse.
