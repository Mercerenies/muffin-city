...
**** accepted
     ////
**** locksmith
     ///// Here, Steve will have fallen to the underworld by the
     curse. The Reaper will send the player to Johnny ("Mr. Death",
     ahem), and Johnny will bring her back to the Other Room.
...
*** ~steve-disappeared~
**** no
     Steve is still present in the past. ////
**** gone
     ////
* CHARACTERS
