...
**** failed
     ...
     will decide the player is "faulty" and kill him, moving the game
     to ~killed~.
**** killed
     The player has been "killed" by the Robot King. The Mesmerist
     will still offer to perform the hypnotism
* CHARACTERS
