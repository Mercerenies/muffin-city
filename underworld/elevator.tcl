...
namespace eval Underworld::Elevator {
    ...
    proc staircase {} {
        ...
        puts "You approach a grand set of stairs leading up to a rather intimidating set of double doors. At\
        the base of the stairs, there is a smaller door that leads to a small lobby. Off to the side, there\
        is a strange hole in the wall leading to some kind of tunnel."
        prompt {} {
    ...
    proc tunnel {} {
        ...
        puts "The strange tunnel stretches on for a long while, but it quickly becomes too narrow for you to\
        proceed. There is an elevator and a door that appears to lead to a science lab. The other doors are\
        on the other side of the narrow tunnel and are inaccessible to you."
        prompt {} {
    ...
    proc scienceLab {} {
        switch [state get johnny-quest] {
            ...
            default {
                ...
                puts "The science lab is surprisingly futuristic looking, given the surrounded environment.\
                $cipher"
                prompt {} {
    ...
    proc lift {back} {
        if {[inv has {Elevator Access Key}]} then {
            puts "== Elevator =="
            puts "The elevator is relatively small, only big enough for two or three people. There are a\
            handful of buttons on the panel, but only a few of them are lit up."
    ...
    proc cipherTalk {} {
        if {[state get talked-to-cipher]} then {
            ...
            puts "\"Heyyyy you're that girl who's helping ol' Johnny. Or guy, I never have the time to tell\
            the difference.\""
            puts "\"Anyway, I'm Dr. Cipher, and Johnny has told me all about you. Would you like to hear about\
            my latest invention?\""
            prompt {} {
    ...
    proc cipherExplain {answer} {
        ...
        puts "\"I call it the Document Transmogrifier! With just the press of a button, I can erase your name\
        and information from every record in every database in the universe! Criminal record? Gone! History of\
        psychological problems? Erased! Every document with your name on it gets shredded. And since you're a\
        friend of Johnny's, you can use it anytime!\""
        prompt {} {
